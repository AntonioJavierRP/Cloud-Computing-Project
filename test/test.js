...
describe("Manage Activities", function(){
    ...
    it("adds a new activity", function(done){
        request(app).put("/plan/actividades")
            .send({
                "dia": 3,
                "tipo": "cycling",
                "duracion": 6,
    ...
    // Lo ponemos aqui por que si se cumple el put, entonces tendremos al menos una actividad en el día 3 y podremos comprobar
    ...
    // Lo ponemos aqui por que si se cumple el put, entonces tendremos al menos una actividad con id = 1 y podremos comprobarlo
    ...
    // Moficamos la actividad creada anteriormente con el put por que asi nos aseguramos de que existe
    it("modifies a specific activity", function(done){
        request(app).post("/plan/actividades/3/1")
            .send({
                "dia": 3,
                "tipo": "running",
                "duracion": 2,
